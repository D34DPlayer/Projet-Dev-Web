...
import { BButton, BootstrapVue, BootstrapVueIcons } from "bootstrap-vue";
...
describe("ProductForm.vue", () => {
  ...
  it("", async () => {
    ...
    expect(
      wrapper.find("#input-categorie").vm.validity.valueMissing
    ).toBeTruthy();
    expect(
      wrapper.find("#textarea-desc").vm.validity.valueMissing
    ).toBeTruthy();
