...
class TestToken:
    form = {"grant_type": "", "client_id": "", "client_secret": "", "username": "admin", "password": "superpassword"}
    ...
    def test_missing_user(self, client: TestClient):
        ...
        headers = {"Authorization": "Bearer " + create_access_token(dict(sub="i do not exist"))}
    ...
    def test_expired_token(self, client: TestClient):
        ...
        headers = {"Authorization": "Bearer " + create_access_token(dict(sub="admin"), timedelta(minutes=-1))}
